// pages/MySchedule.tsx
import { FaChevronDown } from "react-icons/fa";

const events = [
  { title: "Intro to Codin", person: "Alex", day: 0, startHour: 10, durationHours: 1, color: "#fef3c7" },
  { title: "Intro to Geeding", person: "Alex", day: 1, startHour: 10, durationHours: 1, color: "#fde68a" },
  { title: "Workshop Topics", person: "Sam Maria", day: 3, startHour: 10, durationHours: 1, color: "#e9d5ff" },
  { title: "Webinar Topics", person: "", day: 1, startHour: 14, durationHours: 1, color: "#fecaca" },
  { title: "Essay Writing Tips", person: "Sonia Lee", day: 1, startHour: 14, durationHours: 2, color: "#fecaca" },
  { title: "Essay Writing Tips", person: "Maria", day: 2, startHour: 14, durationHours: 2, color: "#93c5fd" },
  { title: "Essay Writing Tips", person: "Maria", day: 4, startHour: 14, durationHours: 2, color: "#fecaca" },
  { title: "Campus Meeting", person: "Maria", day: 2, startHour: 13, durationHours: 1, color: "#bbf7d0" },
  { title: "Webinar Topics", person: "", day: 4, startHour: 14, durationHours: 1, color: "#fecaca" },
];
...
function WeeklyCalendar() {
  ...
  return (
    ...
    <div className="flex items-center justify-between px-5 py-4">
      <h3 className="text-[15px] font-semibold">Weekly Calendar Hello</h3>
  ...
  <div key={dayIndex} className="relative">
    ...
    {events
      ...
      .map((e, i) => {
        ...
        const height = e.durationHours * 80; // Increased height calculation
        return (
          <div
            key={i}
            className="absolute left-1 right-1 rounded-md border border-slate-300 p-3 text-xs shadow-lg" // left-1 right-1 for wider blocks, p-3 for more padding
            style={{ top: rowStart * 80 + 8, height, background: e.color }} // Updated top calculation
          >
            {/* Removed time display - only title and person */}
    ...
    <aside className="rounded-2xl bg-white shadow ring-1 ring-slate-200">
      ...
      <div className="space-y-4 border-t border-slate-100 px-5 py-4">
        <div className="rounded-lg border border-slate-200 p-3">
          ...
          <p className="mt-1 text-sm font-semibold text-slate-800">Intro to Coding</p>
          <p className="text-xs text-slate-600">with Alex</p>
        ...
        <div className="rounded-lg border border-slate-200 p-3">
          ...
          <p className="mt-1 text-sm font-semibold text-slate-800">Essay Writing Tips</p>
          <p className="text-xs text-slate-600">with Maria</p>
