...
export default function LoginSidebar() {
    ...
    return (
        <div className="login-form-container">
            ...
            {toggle ? (
                <div className={`transition-container ${toggle ? "fade-in" : "fade-out"}`}>
                    ...
                    <form className="login-form" onSubmit={(e) => e.preventDefault()}>
                        ...
                        <div className="create-account">
                            <a href="#" className="create-link" onClick={(e) => { e.preventDefault(); setToggle(!toggle); }}>
                                Create an account
                            </a>
                        </div>
                    </form>
                ...
                <SignUpDetails setToggle={setToggle} />
            )}
        </div>
    );
}
